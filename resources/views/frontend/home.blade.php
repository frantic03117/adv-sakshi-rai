    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ url('public/assets/img/carousel-1.jpg') }}" alt="Carousel Image">
            ...
            <div class="carousel-item">
                <img src="{{ url('public/assets/img/carousel-2.jpg') }}" alt="Carousel Image">
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="{{ url('public/assets/img/carousel-3.jpg') }}" alt="Carousel Image">
                <div class="carousel-caption">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="about-img">
                        <img src="{{ url('public/assets/img/about.jpg') }}" alt="Image">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="feature-img">
                        <img src="{{ url('public/assets/img/feature.jpg') }}" alt="Feature">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="{{ url('public/assets/img/team-1.jpg') }}" alt="Team Image">
                        </div>
                        <div class="team-text">
                            <h2>Adam Phillips</h2>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="{{ url('public/assets/img/team-2.jpg') }}" alt="Team Image">
                        </div>
                        <div class="team-text">
                            <h2>Dylan Adams</h2>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="{{ url('public/assets/img/team-3.jpg') }}" alt="Team Image">
                        </div>
                        <div class="team-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="{{ url('public/assets/img/team-4.jpg') }}" alt="Team Image">
                        </div>
                        <div class="team-text">
                            <h2>Josh Dunn</h2>
    ...
    <div class="faqs">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="faqs-img">
                        <img src="{{ url('public/assets/img/faqs.jpg') }}" alt="Image">
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="section-header">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonials-carousel">
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url('public/assets/img/testimonial-1.jpg') }}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url('public/assets/img/testimonial-2.jpg') }}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url('public/assets/img/testimonial-3.jpg') }}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url('public/assets/img/testimonial-4.jpg') }}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
    ...
    <div class="blog">
        <div class="container">
            ...
            <div class="owl-carousel blog-carousel">
                <div class="blog-item">
                    <img src="{{ url('public/assets/img/blog-1.jpg') }}" alt="Blog">
                ...
                <div class="blog-item">
                    <img src="{{ url('public/assets/img/blog-2.jpg') }}" alt="Blog">
                    <h3>Lorem ipsum dolor</h3>
                    <div class="meta">
                        <i class="fa fa-list-alt"></i>
                        <a href="">Family Law</a>
                ...
                <div class="blog-item">
                    <img src="{{ url('public/assets/img/blog-3.jpg') }}" alt="Blog">
                    <h3>Lorem ipsum dolor</h3>
                    <div class="meta">
                        <i class="fa fa-list-alt"></i>
